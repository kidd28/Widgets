 ...
 * Use the {@link her#newInstance} factory method to
...
public class her extends Fragment {
    ...
    String storagePath = "Her_Picture/";
     ...
     * @return A new instance of fragment her.
     */
    // TODO: Rename and change types and number of parameters
    public static her newInstance(String param1, String param2) {
        her fragment = new her();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_her, container, false);


        image = v.findViewById(R.id.imageView);
        text = v.findViewById(R.id.text);
        button = v.findViewById(R.id.herbutton);
    ...
    private void uploadMessage(String message) {
        ...
        reference.child("her").updateChildren(hashmap).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
    ...
    private void updateText() {
        ...
        Query query = reference1.orderByChild("user").equalTo("her");
                ...
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        if (uriTask.isSuccessful()) {
                            ...
                            reference.child("her").updateChildren(results)
